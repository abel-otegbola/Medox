...
import { MemoizedParticipantGrid } from "@/components/live-stream/ParticipantGrid";
...
function ILSParticipantView({ isPresenting }) {
  ...
  }, [ participants, activeSpeakerId, pinnedParticipants,presenterId, localScreenShareOn ]); // eslint-disable-line react-hooks/exhaustive-deps
