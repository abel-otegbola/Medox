...
export default function Sidebar() {
    ...
    return (
        <>
            ...
            <div className={`flex flex-col justify-between md:sticky fixed top-[55px] right-0 h-screen z-[20] md:w-[250px] w-full p-2 border border-gray/[0.3] dark:border-gray/[0.08] dark:bg-dark dark:text-gray 
