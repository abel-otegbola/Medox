...
import NewSchedule from "../schedules/createSchedule"
...
export default function ScheduleGrid({element, layout}: { element: ScheduleData, layout: string }) {
    ...
    return (
        ...
        <div 
            ...
            style={{ top: scheduleLayout(element.durationStart + "," + element.durationEnd).top, height: !open ? scheduleLayout(element.durationStart + "," + element.durationEnd).height : "auto" }} 
        ...
        {
            openEdit ?
            <NewSchedule doctor={""} setClose={setOpenEdit} schedule={element} />
            :""
        }
    </>
    )
