...
export default function DashboardHeader() {
    ...
    return (
        <div className="flex items-center justify-between sticky top-0 left-0 w-full z-[50] px-4 bg-white dark:bg-dark dark:text-gray p-3 border border-transparent border-b-primary/[0.1]">
            ...
            <div ref={menuRef} className="md:flex hidden items-center justify-end gap-6 xl:w-[40%] md:w-[35%] relative">
